                 ...
                 <div class="col-md-4">
                    <div data-pages="portlet" class="panel panel-default" id="portlet-basic">
                      <div class="panel-heading ">
                        <div class="panel-title">Category:
                        </div>
                      ...
                      <div class="panel-body">
                        <h3>
                        {{{$category->cat_name}}}</h3>
                        <p>{{{$category->cat_description}}}
                        </p>
                        @foreach($category->eventlings as $eventling)
                        @if($eventling->is_active < 3)
                            <a href="/bet/{{$eventling->id}}" class="btn">{{$eventling->event_name}}</a>
                        @endif
                        @endforeach 
                      </div>
                    </div>
